                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                ...
                                <form class="form-horizontal" action="<?= base_url('roles/update') ?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="role_name" id="role_name"
                                                   required value="<?= $inputs['role_name'] ?>"
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-sm-2 align-self-center mb-0" for="isactive">Aktif</label>

                                        <div class="col-sm-10">
                                            <input type="checkbox" name="isactive"
                                                   id="isactive" <?= ($inputs['isactive'] == 'Y') ? "checked" : "" ?>>
                                        </div>
                                    </div>
