                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Ubah Pemasukan</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                                ...
                                <form class="form-horizontal" action="<?= base_url('income/update') ?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="income_date" id="income_date"
                                                   value="<?= date('Y-m-d', strtotime($inputs['income_date'])) ?>"
